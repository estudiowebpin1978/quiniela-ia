  ...
  return (
    ...
    >
      {showTooltip && (
        <div
          style={{
            background: "linear-gradient(135deg,rgba(20,20,40,0.98),rgba(10,10,25,1))",
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 4px 0 #075E54, 0 6px 20px rgba(37,211,102,0.4)",
      ...
      <style>{`
        @keyframes fabPulse {
          0%, 100% { box-shadow: 0 4px 0 #075E54, 0 6px 20px rgba(37,211,102,0.4); }
          50% { box-shadow: 0 4px 0 #075E54, 0 6px 30px rgba(37,211,102,0.6); }
        }
