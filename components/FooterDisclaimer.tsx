    ...
    <footer style={{ marginTop: 24, padding: "16px 16px", borderTop: "1px solid rgba(255,255,255,.06)", background: "rgba(0,0,0,0.2)" }}>
      <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
        ...
        <div style={{ fontSize: 10, color: "#475569", lineHeight: 1.5 }}>
          Quiniela IA es una herramienta de análisis estadístico con fines de entretenimiento. No garantiza resultados. No es un sitio de apuestas. Línea de ayuda: <strong style={{ color: "#64748b" }}>0800-333-0062</strong>. Solo mayores de 18 años.
        </div>
