  ...
  return (<>
    ...
    <div style={{
      ...
      <div className="glass-card" style={{
        ...
        {/* Google OAuth Button */}
        <button onClick={googleLogin} disabled={busy} style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 11, color: "var(--text-muted)", fontWeight: 600, textTransform: "uppercase", letterSpacing: 1 }}>o usá tu email</span>
          <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.08)" }} />
        </div>
