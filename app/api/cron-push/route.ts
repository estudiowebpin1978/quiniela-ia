...
export async function GET(req: NextRequest) {
  ...
  const diffMin = Math.abs((turnoActual.hora * 60 + turnoActual.min) - (currentHour * 60 + currentMin))
  ...
  logCronExecution("cron-push", { turno: turnoActual.nombre, sent: result.sent, failed: result.failed, subs: subCount }, t0)
