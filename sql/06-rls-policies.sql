...
-- Ejecutar DESPUÉS de 05-rpc-backtest.sql
-- ============================================================================
...
CREATE POLICY "public_read_draws" ON draws
  FOR SELECT USING (true);
CREATE POLICY "service_write_draws" ON draws
  FOR INSERT WITH CHECK (auth.role() = 'service_role');
CREATE POLICY "service_update_draws" ON draws
  FOR UPDATE USING (auth.role() = 'service_role');

-- ============================================================================
-- 3. USER_PROFILES (owner read/write, service write)
-- ============================================================================
...
CREATE POLICY "owner_read_profile" ON user_profiles
  FOR SELECT USING (auth.uid() = id OR auth.role() = 'service_role');
CREATE POLICY "owner_update_profile" ON user_profiles
  FOR UPDATE USING (auth.uid() = id);
CREATE POLICY "service_write_profile" ON user_profiles
  FOR INSERT WITH CHECK (auth.role() = 'service_role');
CREATE POLICY "service_delete_profile" ON user_profiles
  FOR DELETE USING (auth.role() = 'service_role');

-- ============================================================================
-- 4. USER_PREDICTIONS (owner read/write, service write)
-- ============================================================================
...
CREATE POLICY "owner_read_predictions" ON user_predictions
  FOR SELECT USING (auth.uid() = user_id OR auth.role() = 'service_role');
CREATE POLICY "owner_insert_predictions" ON user_predictions
  FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY "owner_delete_predictions" ON user_predictions
  FOR DELETE USING (auth.uid() = user_id);
CREATE POLICY "service_write_predictions" ON user_predictions
  FOR INSERT WITH CHECK (auth.role() = 'service_role');
CREATE POLICY "service_delete_predictions" ON user_predictions
  FOR DELETE USING (auth.role() = 'service_role');

-- ============================================================================
-- 5. PREDICTION_HISTORY (owner read, service write)
-- ============================================================================
...
CREATE POLICY "owner_read_history" ON prediction_history
  FOR SELECT USING (auth.uid() = user_id OR auth.role() = 'service_role');
CREATE POLICY "service_write_history" ON prediction_history
  FOR INSERT WITH CHECK (auth.role() = 'service_role');

-- ============================================================================
-- 6. TURN_ANALYTICS (authenticated read, service write)
-- ============================================================================
...
CREATE POLICY "authenticated_read_analytics" ON turn_analytics
  FOR SELECT USING (auth.role() = 'authenticated' OR auth.role() = 'anon');
CREATE POLICY "service_write_analytics" ON turn_analytics
  FOR INSERT WITH CHECK (auth.role() = 'service_role');
CREATE POLICY "service_update_analytics" ON turn_analytics
  FOR UPDATE USING (auth.role() = 'service_role');

-- ============================================================================
-- 7. BACKTEST_RESULTS (authenticated read, service write)
-- ============================================================================
...
-- ============================================================================
-- 8. ML_MODELS (authenticated read, service write)
-- ============================================================================
ALTER TABLE ml_models ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "authenticated_read_ml" ON ml_models;
DROP POLICY IF EXISTS "service_write_ml" ON ml_models;
CREATE POLICY "authenticated_read_ml" ON ml_models
  FOR SELECT USING (auth.role() = 'authenticated' OR auth.role() = 'anon');
CREATE POLICY "service_write_ml" ON ml_models
  FOR INSERT WITH CHECK (auth.role() = 'service_role');
CREATE POLICY "service_update_ml" ON ml_models
  FOR UPDATE USING (auth.role() = 'service_role');

-- ============================================================================
-- 9. ML_DL_MODELS (authenticated read, service write)
-- ============================================================================
...
CREATE POLICY "authenticated_read_dl" ON ml_dl_models
  FOR SELECT USING (auth.role() = 'authenticated' OR auth.role() = 'anon');
CREATE POLICY "service_write_dl" ON ml_dl_models
  FOR INSERT WITH CHECK (auth.role() = 'service_role');
CREATE POLICY "service_update_dl" ON ml_dl_models
  FOR UPDATE USING (auth.role() = 'service_role');

-- ============================================================================
-- 10. MOTOR_PERFORMANCE (authenticated read, service write)
-- ============================================================================
...
CREATE POLICY "authenticated_read_motor" ON motor_performance
  FOR SELECT USING (auth.role() = 'authenticated' OR auth.role() = 'anon');
CREATE POLICY "service_write_motor" ON motor_performance
  FOR INSERT WITH CHECK (auth.role() = 'service_role');
CREATE POLICY "service_update_motor" ON motor_performance
  FOR UPDATE USING (auth.role() = 'service_role');
